      ...
      <ChakraProvider>
        ...
        <Routes>
          ...
          <Route element={<ProtectedRoute />}>
            {/* If you want My Ads / Wishlist / Post Ad, add them here when pages exist */}
            {/* <Route path="/my-ads" element={<MyAds />} /> */}
            {/* <Route path="/wishlist" element={<Wishlist />} /> */}
            {/* <Route path="/post-ad" element={<PostAd />} /> */}

            {/* Admin panel (protect all admin pages behind login) */}
            <Route path="/AdminPanel" element={<AdminPanel />} />
            <Route path="/AdminPanel/categories" element={<AdminPanelCategories />} />
            <Route path="/AdminPanel/orders" element={<AdminPanelOrders />} />
